...
class LoginsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'mobile' => ['type' => 'string', 'length' => 10, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'gcm_id' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'mobile' => 'Lorem ip',
            'gcm_id' => 'Lorem ipsum dolor sit amet'
        ],
    ];
}
